...
public class AdminCouponController {
    ...
    public ApiResponse<List<CouponUsageHistoryResponse>> getUsageHistory(@PathVariable Long id) {
        return ApiResponse.success("Lấy lịch sử sử dụng mã giảm giá thành công",
                couponService.getCouponUsageHistory(id));
    }
}
